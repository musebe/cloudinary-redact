...
Project name: `cloudinary-redact`. The Hono/Vercel shell, health route, environment contract, and test foundation are complete. Upload, OCR, classification, redaction, review, and benchmark evidence remain implementation work.
